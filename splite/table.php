...
<head>
  ...
  <tbody>
  	<?php foreach($listlivraisons as $livraison): ?>
    <tr>
     ...
     <td>
              <a href="modifier.php?id=<?= $livraison->idcommande ?> "   class="btn btn-info"> Edit </a>
<a onclick="return confirm('Are you sure you want to delete this entry ?')" href="supprimer.php?id=<?= $livraison->idcommande ?>" class="btn btn-danger"> Delete </a>
            </td>
    </tr>
  </tbody>
    <?php endforeach; ?>
											...
											<div class="table-responsive">
												<table class="table table-striped table-bordered mb-0 text-nowrap">
													...
													<tr>
														...
														<td>
															<img alt="image" src="assets/img/avatar/avatar-5.jpg" class="rounded-circle" width="35" data-toggle="title" title="Wildan Ahdian">
														</td>
														<td>10-11-2018</td>
													...
													<tr>
														...
														<td>
															<img alt="image" src="assets/img/avatar/avatar-3.jpg" class="rounded-circle" width="35" data-toggle="title" title="Nur Alpiana">
															<img alt="image" src="assets/img/avatar/avatar-3.jpg" class="rounded-circle" width="35" data-toggle="title" title="Hariono Yusup">
															<img alt="image" src="assets/img/avatar/avatar-4.jpg" class="rounded-circle" width="35" data-toggle="title" title="Bagus Dwi Cahya">
														</td>
														<td>29-11-2018</td>
													...
													<tr>
														...
														<td>
															<img alt="image" src="assets/img/avatar/avatar-3.jpg" class="rounded-circle" width="35" data-toggle="title" title="Rizal Fakhri">
															<img alt="image" src="assets/img/avatar/avatar-2.jpg" class="rounded-circle" width="35" data-toggle="title" title="Hasan Basri">
														</td>
														<td>31-10-2018</td>
													...
													<tr>
														...
														<td>
															<img alt="image" src="assets/img/avatar/avatar-2.jpg" class="rounded-circle" width="35" data-toggle="title" title="Rizal Fakhri">
															<img alt="image" src="assets/img/avatar/avatar-5.jpg" class="rounded-circle" width="35" data-toggle="title" title="Isnap Kiswandi">
															<img alt="image" src="assets/img/avatar/avatar-4.jpg" class="rounded-circle" width="35" data-toggle="title" title="Yudi Nawawi">
															<img alt="image" src="assets/img/avatar/avatar-3.jpg" class="rounded-circle" width="35" data-toggle="title" title="Khaerul Anwar">
														</td>
														<td>15-10-2018</td>
